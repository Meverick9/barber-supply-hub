      ...
      <body>
        ...
        <header className="siteHeader">
          <div className="container headerRow">
            ...
            <nav className="nav">
              ...
              <a href="/barbers/marco-rossi">Barber Profile</a>
            </nav>
          </div>
        </header>
        ...
        <footer className="footer">
          <div className="container footerRow">
            <span>© {new Date().getFullYear()} Barber Supply Hub</span>
            <span className="muted">Affiliate disclosure: we may earn commissions.</span>
          </div>
        </footer>
      </body>
    </html>
