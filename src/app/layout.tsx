...
export const metadata: Metadata = {
  ...
  title: {
    template: '%s | BarberSuplyHub',
    default: 'Best Barber Clippers & Tools 2026 — Tested by Pro Barbers | BarberSuplyHub',
  },
  ...
  openGraph: { siteName:'BarberSuplyHub', type:'website', images:[{ url:'/og-image.jpg', width:1200, height:630 }] },
...
const WEBSITE_SCHEMA = {
  ...
  name:'BarberSuplyHub', url:SITE_URL,
  inLanguage:['en','es','de'],
...
const ORG_SCHEMA = {
  ...
  sameAs:['https://youtube.com/@barbersuplyhub','https://instagram.com/barbersuplyhub'],
}
